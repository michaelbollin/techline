...
### Anthropic (`anthropic`) — 6 events

| Date | Event id | Title |
|------|----------|-------|
| 2021-01 | `dario-amodei-anthropic-founded` | Dario Amodei co-founds Anthropic |
| 2023-07-11 | `claude-2-released` | Anthropic Claude 2 released |
| 2024-03-04 | `claude-3-released` | Anthropic Claude 3 released |
| 2024-06-20 | `claude-3-5-sonnet-released` | Anthropic Claude 3.5 Sonnet released |
| 2024-10-22 | `claude-3-5-haiku-released` | Anthropic Claude 3.5 Haiku released |
| 2025-02-24 | `claude-3-7-sonnet-released` | Anthropic Claude 3.7 Sonnet released |

### Apache Software Foundation (`apache-software-foundation`) — 6 events

| Date | Event id | Title |
|------|----------|-------|
| 1995-04-21 | `apache-http-server-released` | Apache HTTP Server first public release |
| 1999-06 | `apache-tomcat-released` | Apache Tomcat released |
| 2000-07-19 | `ant-released` | Apache Ant first released |
| 2004-07-13 | `maven-1-0-released` | Apache Maven 1.0 released |
...
| 2024-09-16 | `swift-6-released` | Swift 6 released |

### Atlassian (`atlassian`) — 1 events

| Date | Event id | Title |
|------|----------|-------|
| 2008-06-24 | `bitbucket-launched` | Bitbucket launched |

### Bell Labs (`bell-labs`) — 4 events

| Date | Event id | Title |
|------|----------|-------|
| 1969 | `b-language-created` | Unix language before C created |
| 1972 | `c-language-created` | C programming language takes shape at Bell Labs |
| 1976-04 | `make-created` | Make build tool created |
| 1977 | `awk-created` | AWK created at Bell Labs |

### CERN (`cern`) — 3 events

| Date | Event id | Title |
|------|----------|-------|
| 1990-12 | `worldwideweb-browser` | WorldWideWeb — first web browser |
| 1991 | `html-invented` | HTML invented |
| 1993-04-30 | `berners-lee-web-public-domain` | CERN releases the web into the public domain |

### Docker (`docker`) — 4 events

| Date | Event id | Title |
|------|----------|-------|
| 2011-09-01 | `circleci-launched` | CircleCI founded |
| 2013-03 | `docker-open-sourced` | Docker open-sourced |
...
| Date | Event id | Title |
|------|----------|-------|
| 1985-03 | `stallman-gnu-manifesto` | Richard Stallman publishes the GNU Manifesto |
| 1985-10-04 | `richard-stallman-fsf-founded` | Richard Stallman founds the Free Software Foundation |
| 1987-03-22 | `gcc-1-0-released` | GCC 1.0 released |
...
| Date | Event id | Title |
|------|----------|-------|
| 2008-04-10 | `github-launched` | GitHub launched |
| 2011-02-05 | `travis-ci-launched` | Travis CI launched |
| 2014-04-21 | `tom-preston-werner-github-resigns` | Tom Preston-Werner resigns from GitHub |
...
| Date | Event id | Title |
|------|----------|-------|
| 1998-09-04 | `google-founded` | Larry Page and Sergey Brin incorporate Google |
| 2001-08 | `eric-schmidt-google-ceo` | Eric Schmidt named Google CEO |
| 2007-11-05 | `android-announced` | Android announced |
...
| 2012-03-28 | `go-1-0-released` | Go 1.0 released |
| 2012-05-03 | `samsung-internet-released` | Samsung Internet browser launched |
| 2012-06-27 | `chrome-for-android-released` | Chrome for Android released |
| 2013-04-03 | `blink-engine-announced` | Google announced Blink rendering engine |
| 2013-05 | `opera-chromium-switch` | Opera switched to Chromium |
| 2014-06-10 | `kubernetes-open-sourced` | Kubernetes open-sourced |
| 2015-02-26 | `grpc-open-sourced` | gRPC open-sourced |
| 2015-03-24 | `bazel-open-sourced` | Bazel open-sourced |
| 2015-04-28 | `caddy-released` | Caddy first released |
| 2015-08-10 | `sundar-pichai-google-ceo` | Sundar Pichai named Google CEO |
| 2016-01-20 | `brave-browser-launched` | Brave browser launched |
| 2016-02-15 | `kotlin-1-0-released` | Kotlin 1.0 released |
| 2016-03-15 | `demis-hassabis-alphago-victory` | Demis Hassabis's AlphaGo defeats Lee Sedol 4–1 |
| 2016-04-12 | `vivaldi-browser-launched` | Vivaldi browser launched |
| 2016-09-14 | `angular-2-released` | Angular 2.0 final released |
| 2016-11-17 | `helm-2-released` | Helm 2.0 released |
...
| 2018-12-04 | `flutter-1-0-released` | Flutter 1.0 released |
...
| 2021-01 | `chrome-manifest-v3` | Chrome Manifest V3 extension platform |
| 2022-03-15 | `go-1-18-generics` | Go 1.18 added generics |
| 2022-04-19 | `arc-browser-released` | Arc browser launched |
| 2023-05-01 | `geoffrey-hinton-google-departure` | Geoffrey Hinton leaves Google warning of AI risks |
| 2023-05-10 | `dart-3-released` | Dart 3 released |
| 2023-12-06 | `google-gemini-released` | Google Gemini announced |
| 2024-02-15 | `google-gemini-1-5-released` | Google Gemini 1.5 announced |
| 2024-05-21 | `kotlin-2-0-released` | Kotlin 2.0 released |

### HashiCorp (`hashicorp`) — 2 events

| Date | Event id | Title |
|------|----------|-------|
| 2010-03-07 | `vagrant-released` | Vagrant first released |
| 2014-07-28 | `terraform-released` | Terraform first released |

### Heroku (`heroku`) — 1 events
...
| Date | Event id | Title |
|------|----------|-------|
| 1957-02-26 | `fortran-formally-published` | FORTRAN formally published |
| 1957-04 | `fortran-first-delivery` | First FORTRAN compiler delivered |
| 1964-04-07 | `ibm-system-360-announced` | IBM System/360 announced |
...
| Date | Event id | Title |
|------|----------|-------|
| 1983-01-01 | `tcp-ip-flag-day` | ARPANET switches to TCP/IP |
| 1983-05 | `telnet-standardized` | Telnet standardized |
| 1983-11 | `dns-standardized` | DNS standardized |
| 1985-10 | `ftp-standardized` | FTP standardized |
| 1994-06 | `uri-standardized` | URI syntax standardized |
| 1995-03 | `ldap-standardized` | LDAP standardized |
| 1997-01 | `http-1-1-standardized` | HTTP/1.1 standardized |
| 1999-01 | `tls-1-0-standardized` | TLS 1.0 standardized |
| 2011-12 | `websocket-protocol-standardized` | WebSocket protocol standardized |
| 2012-10 | `oauth-2-0-standardized` | OAuth 2.0 standardized |
| 2015-05 | `jwt-standardized` | JWT standardized |
...
| Date | Event id | Title |
|------|----------|-------|
| 2001-01 | `intellij-idea-released` | IntelliJ IDEA released |
| 2011-07-19 | `kotlin-unveiled` | Kotlin announced |
| 2016-02-15 | `kotlin-1-0-released` | Kotlin 1.0 released |
| 2017-05-17 | `kotlin-android-official` | Kotlin made official for Android |
| 2024-05-21 | `kotlin-2-0-released` | Kotlin 2.0 released |
...
| 2016-10-25 | `nextjs-open-sourced` | Next.js open sourced |
| 2018-01-23 | `yann-lecun-meta-chief-ai` | Yann LeCun named Facebook chief AI scientist |
| 2018-11-06 | `graphql-foundation-announced` | GraphQL Foundation announced |
| 2022-10-25 | `nextjs-13-app-router` | Next.js 13 introduced the App Router |
...
| 2002-02-13 | `visual-basic-net-released` | Visual Basic .NET released with .NET Framework |
| 2005-11-07 | `dotnet-framework-2-0-released` | .NET Framework 2.0 and C# 2.0 released |
| 2006-10-18 | `internet-explorer-7-released` | Internet Explorer 7 released |
...
| 2010-10-05 | `nuget-released` | NuGet released |
| 2011-03-14 | `internet-explorer-9-released` | Internet Explorer 9 released |
...
| 2015-04-29 | `visual-studio-code-preview` | Visual Studio Code preview released |
| 2015-07-20 | `csharp-6-roslyn-released` | C# 6 and Roslyn compiler released |
| 2015-07-29 | `microsoft-edge-released` | Microsoft Edge released with Windows 10 |
| 2016-06-27 | `dotnet-core-1-0-released` | .NET Core 1.0 released |
| 2016-06-27 | `language-server-protocol-announced` | Language Server Protocol announced |
| 2016-08-18 | `powershell-core-open-sourced` | PowerShell open-sourced on GitHub |
| 2016-09-14 | `angular-2-released` | Angular 2.0 final released |
...
| 2020-01-15 | `edge-chromium-released` | Chromium-based Microsoft Edge released |
| 2020-11-10 | `dotnet-5-released` | .NET 5 released |
| 2020-11-10 | `csharp-9-released` | C# 9 released with .NET 5 |
| 2021-11-08 | `dotnet-6-released` | .NET 6 LTS released |
| 2021-11-08 | `csharp-10-released` | C# 10 released with .NET 6 |
| 2022-06-15 | `internet-explorer-11-retired` | Internet Explorer 11 retired |
| 2022-11-08 | `dotnet-7-released` | .NET 7 released |
| 2022-11-08 | `csharp-11-released` | C# 11 released with .NET 7 |
| 2023-03-20 | `typescript-5-0-released` | TypeScript 5.0 released |
| 2023-11-14 | `dotnet-8-released` | .NET 8 LTS released |
| 2023-11-14 | `csharp-12-released` | C# 12 released with .NET 8 |
| 2024-11-12 | `dotnet-9-released` | .NET 9 released |
| 2024-11-12 | `csharp-13-released` | C# 13 released with .NET 9 |

### MongoDB (`mongodb`) — 1 events

| Date | Event id | Title |
|------|----------|-------|
| 2009-02-11 | `mongodb-first-released` | MongoDB first released |

### Mozilla (`mozilla`) — 11 events

| Date | Event id | Title |
|------|----------|-------|
| 1998-03-31 | `mozilla-source-released` | Mozilla source code open-sourced |
| 2003-07-15 | `mozilla-foundation-created` | Mozilla Foundation created |
| 2004-11-09 | `firefox-1-0-released` | Firefox 1.0 released |
| 2005-11-29 | `firefox-1-5-released` | Firefox 1.5 released |
| 2008-02-01 | `netscape-browser-discontinued` | Netscape browser discontinued |
| 2008-06-17 | `firefox-3-released` | Firefox 3.0 released |
| 2011-03-22 | `firefox-4-released` | Firefox 4 released |
| 2011-06-21 | `firefox-5-released` | Firefox 5 released |
| 2011-08-16 | `firefox-6-released` | Firefox 6 released |
| 2014-04-03 | `brendan-eich-mozilla-ceo-resigns` | Brendan Eich resigns as Mozilla CEO |
| 2017-11-14 | `firefox-57-quantum` | Firefox 57 Quantum released |

### Netflix (`netflix`) — 1 events

| Date | Event id | Title |
|------|----------|-------|
| 2007-01-16 | `reed-hastings-netflix-streaming` | Reed Hastings launches Netflix streaming |

### Netscape (`netscape`) — 9 events

| Date | Event id | Title |
|------|----------|-------|
| 1994-04-04 | `marc-andreessen-netscape-founded` | Marc Andreessen and Jim Clark found Netscape |
| 1994-12-15 | `netscape-navigator-1-0` | Netscape Navigator 1.0 shipped |
| 1995-05 | `javascript-mocha-prototype` | JavaScript prototyped at Netscape |
| 1995-12-04 | `javascript-name-announced` | JavaScript name announced by Netscape and Sun |
| 1996-03-18 | `netscape-navigator-2-0` | Netscape Navigator 2.0 shipped |
| 1997-06 | `ecmascript-1-adopted` | JavaScript standardized |
| 1997-06-11 | `netscape-communicator-4-0` | Netscape Communicator 4.0 released |
| 1998-03-31 | `mozilla-source-released` | Mozilla source code open-sourced |
| 2008-02-01 | `netscape-browser-discontinued` | Netscape browser discontinued |

### Nginx (`nginx`) — 2 events
...
| 2025-04-14 | `gpt-4-1-released` | OpenAI GPT-4.1 released |

### Opera (`opera`) — 5 events

| Date | Event id | Title |
|------|----------|-------|
| 1996-04 | `opera-2-released` | Opera 2.0 publicly released |
| 2005-08 | `opera-mini-launched` | Opera Mini launched for mobile phones |
| 2013-05 | `opera-chromium-switch` | Opera switched to Chromium |
| 2016-04-12 | `vivaldi-browser-launched` | Vivaldi browser launched |
| 2019-06-11 | `opera-gx-released` | Opera GX browser released |
...
| 2001-01 | `intellij-idea-released` | IntelliJ IDEA released |
| 2001-11-07 | `eclipse-open-sourced` | Eclipse IDE open-sourced |
| 2004-01-20 | `scala-first-release` | Scala first public release |
| 2004-03-24 | `spring-framework-1-0-released` | Spring Framework 1.0 released |
| 2004-07-13 | `maven-1-0-released` | Apache Maven 1.0 released |
| 2004-09-30 | `java-5-released` | Java 5 (Tiger) released |
...
| 2010-04-09 | `james-gosling-leaves-oracle` | James Gosling leaves Oracle |
| 2011-07-19 | `kotlin-unveiled` | Kotlin announced |
| 2014-03-18 | `java-8-released` | Java 8 released |
| 2016-02-15 | `kotlin-1-0-released` | Kotlin 1.0 released |
| 2018-09-25 | `java-11-released` | Java 11 LTS released |
| 2021-05-04 | `scala-3-released` | Scala 3.0 released |
| 2021-09-14 | `java-17-released` | Java 17 LTS released |
| 2023-09-19 | `java-21-released` | Java 21 LTS released |

### TSMC (`tsmc`) — 1 events

| Date | Event id | Title |
|------|----------|-------|
| 1987-02-21 | `morris-chang-tsmc-founded` | Morris Chang founds TSMC |

### Vercel (`vercel`) — 2 events
...
| Date | Event id | Title |
|------|----------|-------|
| 1994-10-01 | `tim-berners-lee-w3c-founded` | Tim Berners-Lee founds the W3C |
| 1994-10-10 | `haakon-lie-css-proposed` | Håkon Wium Lie proposes CSS |
| 1996-05 | `amaya-browser-released` | Amaya — W3C browser and editor |
| 2003-06-24 | `soap-1-2-standardized` | SOAP 1.2 became a W3C Recommendation |

---

## Event index

| Event id | Company | How |
|----------|---------|-----|
| `fortran-formally-published` | IBM | tag |
| `fortran-first-delivery` | IBM | tag |
| `ibm-system-360-announced` | IBM | tag |
| `moore-noyce-intel-founded` | Intel | tag |
| `b-language-created` | Bell Labs | tag |
| `c-language-created` | Bell Labs | tag |
| `sequel-paper-published` | IBM | tag |
...
| `apple-lisa-released` | Apple | tag |
| `ibm-pc-xt-released` | IBM | tag |
| `telnet-standardized` | IETF | tag |
| `dns-standardized` | IETF | tag |
...
| `intel-80386-introduced` | Intel | tag |
...
| `tim-berners-lee-w3c-founded` | W3C | tag |
| `haakon-lie-css-proposed` | W3C | tag |
| `netscape-navigator-1-0` | Netscape | tag |
| `jetty-released` | Sun Microsystems | tag |
| `delphi-1-0-launched` | Microsoft | tag |
| `ldap-standardized` | IETF | tag |
...
| `amaya-browser-released` | W3C | tag |
| `internet-explorer-3-0` | Microsoft | tag |
| `http-1-1-standardized` | IETF | tag |
| `ecmascript-1-adopted` | Netscape | tag |
| `netscape-communicator-4-0` | Netscape | tag |
...
| `dotnet-framework-1-0-rtm` | Microsoft | tag |
...
| `spring-framework-1-0-released` | Sun Microsystems | tag |
| `maven-1-0-released` | Apache Software Foundation, Sun Microsystems | tag |
| `java-5-released` | Sun Microsystems | tag |
| `nginx-released` | Nginx | tag |
| `firefox-1-0-released` | Mozilla | tag |
| `hudson-ci-released` | Sun Microsystems | tag |
| `webkit-open-sourced` | Apple | tag |
| `opera-mini-launched` | Opera | tag |
| `werner-vogels-amazon-cto` | Amazon | tag |
| `dotnet-framework-2-0-released` | Microsoft | tag |
| `firefox-1-5-released` | Mozilla | tag |
| `scala-2-0-released` | Sun Microsystems | tag |
| `internet-explorer-7-released` | Microsoft | tag |
| `jensen-huang-cuda-announced` | NVIDIA | tag |
| `powershell-1-0-released` | Microsoft | tag |
...
| `internet-explorer-8-released` | Microsoft | tag |
...
| `firefox-6-released` | Mozilla | tag |
| `circleci-launched` | Docker | tag |
| `dart-unveiled` | Google | tag |
| `websocket-protocol-standardized` | IETF | tag |
| `go-1-0-released` | Google | tag |
| `samsung-internet-released` | Google, Samsung | tag |
| `chrome-for-android-released` | Google | tag |
| `safari-6-released` | Apple | tag |
| `dotnet-framework-4-5-released` | Microsoft | tag |
...
| `react-open-sourced` | Meta | tag |
| `internet-explorer-11-released` | Microsoft | tag |
| `safari-7-released` | Apple | tag |
| `satya-nadella-microsoft-ceo` | Microsoft | tag |
| `java-8-released` | Sun Microsystems | tag |
| `typescript-1-0-released` | Microsoft | tag |
| `brendan-eich-mozilla-ceo-resigns` | Mozilla | tag |
| `tom-preston-werner-github-resigns` | GitHub | tag |
| `swift-announced` | Apple | tag |
| `kubernetes-open-sourced` | Docker, Google | tag |
| `terraform-released` | HashiCorp | tag |
...
| `http-2-standardized` | IETF | tag |
| `swift-2-announced` | Apple | tag |
| `open-container-initiative-launched` | Docker | tag |
| `graphql-open-sourced` | Meta | tag |
| `csharp-6-roslyn-released` | Microsoft | tag |
| `microsoft-edge-released` | Microsoft | tag |
| `sundar-pichai-google-ceo` | Google | tag |
| `safari-9-released` | Apple | tag |
| `sam-altman-openai-founded` | OpenAI | tag |
| `swift-open-sourced` | Apple | tag |
| `ilya-sutskever-openai-research` | OpenAI | tag |
| `brave-browser-launched` | Google | tag |
| `kotlin-1-0-released` | Google, JetBrains, Sun Microsystems | tag |
| `demis-hassabis-alphago-victory` | Google | tag |
| `andy-jassy-aws-ceo` | Amazon | tag |
| `vivaldi-browser-launched` | Google, Opera | tag |
| `dotnet-core-1-0-released` | Microsoft | tag |
| `language-server-protocol-announced` | Microsoft | tag |
| `powershell-core-open-sourced` | Microsoft | tag |
| `angular-2-released` | Google, Microsoft | tag |
| `safari-10-released` | Apple | tag |
| `yarn-released` | Meta | tag |
| `nextjs-open-sourced` | Meta, Vercel | tag |
| `helm-2-released` | Google | tag |
| `samsung-internet-chromium-released` | Google, Samsung | tag |
| `nestjs-announced` | Microsoft | tag |
...
| `yann-lecun-meta-chief-ai` | Meta | tag |
| `ryan-dahl-deno-announced` | Microsoft | tag |
| `java-11-released` | Sun Microsystems | tag |
| `graphql-foundation-announced` | Meta | tag |
| `flutter-1-0-released` | Google | tag |
| `opera-gx-released` | Google, Opera | tag |
...
| `pat-gelsinger-intel-ceo` | Intel | tag |
| `scala-3-released` | Sun Microsystems | tag |
| `safari-15-ios-web-extensions` | Apple | tag |
| `java-17-released` | Sun Microsystems | tag |
| `swift-5-5-async-await` | Apple | tag |
| `dotnet-6-released` | Microsoft | tag |
| `csharp-10-released` | Microsoft | tag |
| `go-1-18-generics` | Google | tag |
| `arc-browser-released` | Google | tag |
| `http-3-standardized` | IETF | tag |
| `internet-explorer-11-retired` | Microsoft | tag |
| `nextjs-13-app-router` | Meta, Vercel | tag |
| `dotnet-7-released` | Microsoft | tag |
| `csharp-11-released` | Microsoft | tag |
| `chatgpt-released` | OpenAI | tag |
| `gpt-3-5-turbo-released` | OpenAI | tag |
| `gpt-4-released` | OpenAI | tag |
...
| `gpt-4-turbo-released` | OpenAI | tag |
| `dotnet-8-released` | Microsoft | tag |
| `csharp-12-released` | Microsoft | tag |
| `google-gemini-released` | Google | tag |
| `google-gemini-1-5-released` | Google | tag |
| `ios-eu-browser-choice` | Apple | tag |
| `claude-3-released` | Anthropic | tag |
| `llama-3-released` | Meta | tag |
| `gpt-4o-released` | OpenAI | tag |
| `kotlin-2-0-released` | Google, JetBrains | tag |
| `claude-3-5-sonnet-released` | Anthropic | tag |
| `openai-o1-released` | OpenAI | tag |
| `swift-6-released` | Apple | tag |
| `claude-3-5-haiku-released` | Anthropic | tag |
| `dotnet-9-released` | Microsoft | tag |
| `csharp-13-released` | Microsoft | tag |
| `claude-3-7-sonnet-released` | Anthropic | tag |
| `gpt-4-1-released` | OpenAI | tag |
