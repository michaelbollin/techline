/**
 * Seeds people milestone events into content/timeline buckets.
 * Run: npm run seed:people
 */
...
import { PEOPLE_MILESTONES } from "./data/people-milestones";
...
async function main() {
  ...
  for (const event of PEOPLE_MILESTONES) {
  ...
  console.log(`People milestones: added ${added}, updated ${updated}.`);
}
